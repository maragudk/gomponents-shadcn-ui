	...
	return sectionWithSource("Carousel", "carousel.go",
		...
		subsection("Default",
			Div(
				...
				data.Signals(map[string]any{"currentSlide": 0}),
	...
	return sectionWithSource("Context Menu", "contextmenu.go",
		subsection("Default",
			ui.ContextMenu(ui.ContextMenuProps{},
				data.Signals(map[string]any{"ctxMenuOpen": false, "ctxX": 0, "ctxY": 0}),
	...
	return sectionWithSource("Drawer", "drawer.go",
		subsection("Default",
			ui.Drawer(ui.DrawerProps{},
				data.Signals(map[string]any{"drawerOpen": false}),
	...
	return sectionWithSource("Menubar", "menubar.go",
		subsection("Default",
			ui.Menubar(ui.MenubarProps{},
				data.Signals(map[string]any{"fileOpen": false, "editOpen": false, "viewOpen": false}),
