...
func comboboxSection() Node {
	// Check icon SVG
	checkIcon := Raw(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-4"><path d="M20 6 9 17l-5-5"/></svg>`)
	// Chevron down icon
	chevronDown := Raw(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-muted-foreground size-4"><path d="m6 9 6 6 6-6"/></svg>`)

	return sectionWithSource("Combobox", "combobox.go",
		P(
			Class("text-muted-foreground mb-6"),
			Text("Autocomplete input with dropdown selection."),
		),

		subsection("Default",
			ui.Combobox(ui.ComboboxProps{},
				ui.ComboboxTrigger(ui.ComboboxTriggerProps{},
					data.Init("$comboboxOpen = false; $comboboxValue = ''"),
					data.On("click", "$comboboxOpen = !$comboboxOpen"),
					data.Attr("aria-expanded", "$comboboxOpen"),
					Class("w-[200px]"),
					ui.ComboboxValue(ui.ComboboxValueProps{Placeholder: "Select framework..."}),
					chevronDown,
				),
				ui.ComboboxContent(ui.ComboboxContentProps{},
					data.Show("$comboboxOpen"),
					ui.ComboboxInput(ui.ComboboxInputProps{Placeholder: "Search framework..."}),
					ui.ComboboxList(ui.ComboboxListProps{},
						ui.ComboboxEmpty(ui.ComboboxEmptyProps{}, Text("No framework found.")),
						ui.ComboboxGroup(ui.ComboboxGroupProps{},
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "next.js"},
								Text("Next.js"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}),
							),
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "sveltekit"},
								Text("SvelteKit"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}),
							),
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "nuxt"},
								Text("Nuxt.js"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}),
							),
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "remix"},
								Text("Remix"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}),
							),
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "astro"},
								Text("Astro"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}),
							),
						),
		...
		subsection("With Selected Item",
			ui.Combobox(ui.ComboboxProps{},
				ui.ComboboxTrigger(ui.ComboboxTriggerProps{},
					data.Init("$combobox2Open = false"),
					data.On("click", "$combobox2Open = !$combobox2Open"),
					data.Attr("aria-expanded", "$combobox2Open"),
					Class("w-[200px]"),
					ui.ComboboxValue(ui.ComboboxValueProps{},
						checkIcon,
						Text("Next.js"),
					),
					chevronDown,
				...
				ui.ComboboxContent(ui.ComboboxContentProps{},
					data.Show("$combobox2Open"),
					ui.ComboboxInput(ui.ComboboxInputProps{Placeholder: "Search framework..."}),
					ui.ComboboxList(ui.ComboboxListProps{},
						ui.ComboboxGroup(ui.ComboboxGroupProps{},
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "next.js", Selected: true},
								Text("Next.js"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}, checkIcon),
							),
							ui.ComboboxItem(ui.ComboboxItemProps{Value: "sveltekit"},
								Text("SvelteKit"),
								ui.ComboboxItemIndicator(ui.ComboboxItemIndicatorProps{}),
...
func commandSection() Node {
	return sectionWithSource("Command", "command.go",
		P(
			Class("text-muted-foreground mb-6"),
			Text("Fast, composable, command palette for filtering and selecting items."),
		),

		subsection("Default",
			Div(
				Class("w-[350px] rounded-lg border shadow-md"),
				ui.Command(ui.CommandProps{},
					ui.CommandInput(ui.CommandInputProps{Placeholder: "Type a command or search..."}),
					ui.CommandList(ui.CommandListProps{},
						ui.CommandEmpty(ui.CommandEmptyProps{}, Text("No results found.")),
						ui.CommandGroup(ui.CommandGroupProps{Heading: "Suggestions"},
							ui.CommandItem(ui.CommandItemProps{Value: "calendar"},
								Raw(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>`),
								Text("Calendar"),
							),
							ui.CommandItem(ui.CommandItemProps{Value: "search"},
								Raw(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>`),
								Text("Search Emoji"),
							),
							ui.CommandItem(ui.CommandItemProps{Value: "calculator"},
								Raw(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>`),
								Text("Calculator"),
							),
						),
						ui.CommandSeparator(ui.CommandSeparatorProps{}),
						ui.CommandGroup(ui.CommandGroupProps{Heading: "Settings"},
							ui.CommandItem(ui.CommandItemProps{Value: "profile"},
								...
								Text("Profile"),
								ui.CommandShortcut(ui.CommandShortcutProps{}, Text("⌘P")),
							),
							ui.CommandItem(ui.CommandItemProps{Value: "billing"},
								Raw(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>`),
								Text("Billing"),
								ui.CommandShortcut(ui.CommandShortcutProps{}, Text("⌘B")),
							),
							ui.CommandItem(ui.CommandItemProps{Value: "settings"},
								...
								Text("Settings"),
								ui.CommandShortcut(ui.CommandShortcutProps{}, Text("⌘S")),
							),
						),
					),
				),
		...
		subsection("Default",
			ui.ContextMenu(ui.ContextMenuProps{},
				...
				ui.ContextMenuContent(ui.ContextMenuContentProps{},
					data.Attr("style", "`left: ${$ctxX}px; top: ${$ctxY}px; position: fixed; display: ${$ctxMenuOpen ? 'block' : 'none'};`"),
					Style("display: none"),
